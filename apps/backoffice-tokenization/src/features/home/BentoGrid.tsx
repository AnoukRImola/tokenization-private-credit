...
const SkeletonTwo = () => {
  ...
  return (
    <motion.div
      ...
      className="flex flex-1 w-full h-full min-h-[6rem] dark:bg-dot-white/[0.2] bg-dot-black/[0.2] flex-col space-y-2"
    >
      {/* Use deterministic widths to avoid SSR/client hydration mismatches */}
      {arr.map((_, i) => {
        const deterministicWidths = [52, 44, 66, 59, 85, 71]; // percentages
        const widthPercent =
          deterministicWidths[i % deterministicWidths.length];
        return (
          <motion.div
            key={"skelenton-two" + i}
            variants={variants}
...
const SkeletonFour = ({ t }: { t: (key: string) => string }) => {
  ...
  return (
    ...
    >
      ...
      >
        <img
          src="https://github.com/JoelVR17.png"
          alt="avatar"
          height="100"
          width="100"
